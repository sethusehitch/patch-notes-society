...
def main():
    html_paths = ["index.html", "share.html", "review-queue.html", "evidence.html", "expert/001-prisons-reviewer-bundle.html", "expert/002-housing-homelessness-reviewer-bundle.html", "expert/003-healthcare-reviewer-bundle.html", "expert/005-addiction-mental-health-reviewer-bundle.html"] + [f"issues/{issue}.html" for issue in REQUIRED_ISSUES]
    ...
    for url in [SITE, SITE + "share.html", SITE + "review-queue.html", SITE + "evidence.html", SITE + "expert/001-prisons-reviewer-bundle.html", SITE + "expert/002-housing-homelessness-reviewer-bundle.html", SITE + "expert/003-healthcare-reviewer-bundle.html", SITE + "expert/005-addiction-mental-health-reviewer-bundle.html", SITE + "feed.xml", SITE + "llms.txt"]:
